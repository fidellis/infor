...
const Model = _sequelize2.default.define('ApresentacaoRotina', {
    id: {
...
Model.afterSync(() => Promise.all([Model.upsert({ id: 1, nome: 'Painel' }), Model.upsert({ id: 2, nome: 'E-mail' }), Model.upsert({ id: 3, nome: 'BBM' })]));
