...
const Model = _sequelize2.default.define('StatusFerramenta', {
    id: {
...
Model.afterSync(() => Promise.all([Model.upsert({ id: 1, nome: 'Construção​' }), Model.upsert({ id: 2, nome: 'Enviado​' }), Model.upsert({ id: 3, nome: 'Avaliado' })]));
