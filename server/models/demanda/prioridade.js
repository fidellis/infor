...
const Model = _sequelize2.default.define('PrioridadeDemanda', {
    id: {
...
Model.afterSync(() => Promise.all([Model.upsert({ id: 1, nome: 'Baixa' }), Model.upsert({ id: 2, nome: 'Normal' }), Model.upsert({ id: 3, nome: 'Alta' })]));
